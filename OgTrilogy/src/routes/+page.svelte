<script>
    ...
    const questions = [
      {
        ...
        answers: [
          ...
          { text: "Deliver a sharp comeback with an icy stare to shut them down.", character: "Princess Leia" },
          { text: "Stand up for myself calmly without escalating the situation.", character: "Luke Skywalker" },
          { text: "Intimidate them into silence (perhaps with a deathly glare).", character: "Darth Vader" },
          { text: "Let out a menacing growl and show them it's a bad idea to mess with me.", character: "Chewbacca" }
        ]
      },
      {
        ...
        answers: [
          ...
          { text: "Keeping my freedom and looking out for number one (with some profit on the side).", character: "Han Solo" },
      ...
      },
      {
        ...
        answers: [
          ...
          { text: "Think of a clever, sneaky solution before confronting it directly.", character: "Obi-Wan Kenobi" },
      ...
      },
      {
        ...
        answers: [
          { text: "Practicing my skills or taking a quick flight looking for adventure.", character: "Luke Skywalker" },
          { text: "Winning a high-stakes game in a cantina and celebrating after.", character: "Han Solo" },
          { text: "Relaxing with close friends, maybe playing a game of holochess.", character: "Chewbacca" },
      ...
      },
      {
        ...
        answers: [
          { text: "Grab the tools and try to fix it myself (with a few choice curse words for good measure!).", character: "Han Solo" },
          { text: "Growl in frustration, then roll up my sleeves and start repairing it by hand.", character: "Chewbacca" },
          { text: "Try a quick fix with what I know, and call for a friend or droid to help if needed.", character: "Luke Skywalker" },
          { text: "Glare and demand the nearest mechanic fix it immediately — or else.", character: "Darth Vader" },
          { text: "Stay calm and improvise a temporary solution, or find an alternate way to reach my destination.", character: "Obi-Wan Kenobi" },
          { text: "Charm a passerby into helping out or hitch a ride on their ship.", character: "Lando Calrissian" }
        ]
      },
      {
        ...
        answers: [
          ...
          { text: "Absolute obedience and following orders without question.", character: "Darth Vader" },
      ...
      },
      {
        ...
        answers: [
          ...
          { text: "All black and imposing, complete with a dramatic cape.", character: "Darth Vader" },
          { text: "Armored up and ready for anything.", character: "Boba Fett" },
          { text: "Refined and stylish – I never say no to a good cape.", character: "Lando Calrissian" }
        ]
      },
      {
        prompt: "If you're put in charge of a group, how do you lead?",
        answers: [
          { text: "Lead by example on the front lines to inspire everyone.", character: "Luke Skywalker" },
          { text: "Give clear orders and keep everyone focused on the mission.", character: "Princess Leia" },
          { text: "Keep it informal and friendly, and improvise if things change.", character: "Han Solo" },
          { text: "Rule with an iron fist – strict discipline and fear to stay in control.", character: "Darth Vader" },
          { text: "Guide the team with wisdom and encourage each person’s strengths.", character: "Yoda" }
        ]
      },
      {
        ...
        answers: [
          ...
          { text: "The Millennium Falcon, of course. Fast and one-of-a-kind.", character: "Han Solo" },
          { text: "An Imperial Star Destroyer to show my might across the stars.", character: "Darth Vader" },
          { text: "My personal ship loaded with hidden weapons.", character: "Boba Fett" },
          { text: "A luxury starship with style and all the comforts.", character: "Lando Calrissian" },
          { text: "Whatever gets me where I'm needed safely (even an Imperial shuttle, if necessary).", character: "Princess Leia" }
        ]
      },
      {
      ...
      },
      {
        ...
        answers: [
          ...
          { text: "Wing it! Turn the failure into an opportunity with some quick thinking.", character: "Han Solo" },
          { text: "Get angry and make sure whoever caused the problem pays for it.", character: "Darth Vader" },
          { text: "Adapt on the fly and keep everyone moving toward the goal.", character: "Princess Leia" },
          { text: "Laugh it off, pretend I meant to do that, and improvise a new plan.", character: "Lando Calrissian" }
        ]
      },
      {
      ...
      },
      {
        ...
        answers: [
          { text: "Try diplomacy first and reason with everyone involved.", character: "Princess Leia" },
          { text: "Come up with a clever trick — or a quick draw of my blaster — to settle it.", character: "Han Solo" },
          { text: "Intimidate or overpower the other side so they stand down.", character: "Darth Vader" },
          { text: "Negotiate a deal or compromise where everyone wins (especially me).", character: "Lando Calrissian" },
          { text: "Act as a calm mediator, or even use a subtle mind trick to defuse the tension.", character: "Obi-Wan Kenobi" }
        ]
      },
      {
        prompt: "If you suddenly discovered you can use the Force, what would you do first?",
        answers: [
          { text: "Find a wise mentor to train me so I can use it to help others.", character: "Luke Skywalker" },
          { text: "Shrug it off — I'd probably still trust my blaster and instincts over some magic force.", character: "Han Solo" },
          { text: "Use it to start taking control of everything and get what I want.", character: "Emperor Palpatine" },
          { text: "Practice responsibly, using it only for knowledge and defense.", character: "Yoda" },
          { text: "Keep it low-key and use it subtly to give myself an edge when I really need it.", character: "Lando Calrissian" }
        ]
      },
      {
        ...
        answers: [
          ...
          { text: "Diplomat or political leader rallying others to a cause.", character: "Princess Leia" },
          ...
          { text: "Galactic emperor – the one calling all the shots.", character: "Emperor Palpatine" }
        ]
      },
      {
        ...
        answers: [
          ...
          { text: "Incompetence or disloyalty from those under my command.", character: "Darth Vader" },
      ...
      },
      {
        ...
        answers: [
          ...
          { text: "In a bustling spaceport cantina or cruising through open space.", character: "Han Solo" },
          { text: "In a command center, where I can organize plans and make a difference.", character: "Princess Leia" },
          { text: "In a beautiful city full of opportunity, enjoying the finer things.", character: "Lando Calrissian" },
          { text: "In a powerful fortress or on the bridge of a starship, overseeing everything.", character: "Darth Vader" }
        ]
      },
      {
        ...
        answers: [
          ...
          { text: "Pretend not to notice at first, but then end up helping anyway.", character: "Han Solo" },
          { text: "Take charge of the situation and organize others to assist.", character: "Princess Leia" },
          { text: "Only get involved if there's a reward or it benefits me.", character: "Boba Fett" },
          { text: "Calmly step in and resolve it quietly before it gets out of hand.", character: "Obi-Wan Kenobi" }
        ]
      },
      {
        ...
        answers: [
          ...
          { text: "Direct, assertive orders (with a bit of dry sarcasm when needed).", character: "Princess Leia" },
          { text: "Few words, mostly commands… and an intimidating silence.", character: "Darth Vader" },
          { text: "Ancient wisdom delivered in quirky, backwards phrases.", character: "Yoda" },
          { text: "Smooth-talking with plenty of charm and flattery.", character: "Lando Calrissian" },
          { text: "Expressive growls and roars – I let my actions do most of the talking.", character: "Chewbacca" }
        ]
      },
      {
        ...
        answers: [
          ...
          { text: "Dive in and take out the enemy head-on with blaster blazing.", character: "Han Solo" },
          { text: "Stay back a bit to coordinate the attack strategy.", character: "Princess Leia" },
          { text: "Engage the strongest enemy personally to strike fear in the others.", character: "Darth Vader" },
          { text: "Hang back and let the brunt of the fighting play out, intervening only when victory is assured.", character: "Emperor Palpatine" },
          { text: "Pick off high-value targets from the sidelines with precision.", character: "Boba Fett" }
        ]
      },
      {
        ...
        answers: [
          ...
          { text: "An outfit that's elegant yet practical (and maybe a hidden blaster).", character: "Princess Leia" },
          { text: "A dark helmet and suit that command respect (and fear).", character: "Darth Vader" }
        ]
      }
    ];
  ...
  <main class="relative z-10 min-h-screen text-white flex flex-col items-center justify-center p-4">
    <!-- Fixed header for the quiz title -->
    <header class="fixed top-0 left-0 w-full py-4 shadow z-20">
      <h1 class="text-center text-4xl font-bold">
        Which Original Trilogy Character Are You?
      </h1>
    </header>
    
    <!-- Quiz container with top margin to avoid the fixed header -->
    <div id="quiz-container" class="w-full max-w-xl rounded-lg shadow-lg p-6 mt-20 ">
      {#if !quizFinished}
        ...
        <div class="space-y-4">
            ...
            <button
              ...
              class="w-full text-left p-4 bg-blue-500 hover:bg-blue-600 rounded"
        ...
        <div class="mt-6 flex justify-end">
          <button on:click={nextQuestion} class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">
            Next
          </button>
        </div>
      {:else}
        <h2 class="text-3xl font-bold mb-4 text-center">
          Your Star Wars Character is:
        </h2>
        <p class="text-2xl text-center">{resultCharacter}</p>
      {/if}
    </div>
  </main>
